...
public class SendSmsSvc {
	...
	public String sendSmsCaptcha(String phoneNumber, String templateId, String chptcha)
			throws UnsupportedEncodingException, ClientException, IOException {
		SmsSendResponse smsSendResponse = sendSms.sendSmsCaptcha(phoneNumber, templateId, chptcha);
	...
	public String sendSmsNotice(String phoneNumber, String userName, String chptcha)
			throws UnsupportedEncodingException, ClientException, IOException {
	...
	public String querySendDetailsByBizId(String phoneNumber, String bizId)
			throws UnsupportedEncodingException, ClientException, IOException {
	...
	public String querySendDetails(Map<String, String> jsonMap)
			throws UnsupportedEncodingException, ClientException, IOException {
